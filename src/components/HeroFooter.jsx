        ...
        <footer class="bg-[#020617]">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 ">
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="https://github.com/lucasns06/churninsight-frontend" class="hover:underline ">Front end</a>
                            </li>
                            <li class="mb-4">
                                <a href="https://github.com/renancvitor/churninsight-backend-h12-25b" class="hover:underline">Back end</a>
                            </li>
                             <li>
                                <a href="https://github.com/LeticiaPaesano/Churn_Hackathon" class="hover:underline ">Data science</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            ...
                            <li class="mb-4">
                                <Link to="#" class="hover:underline">Dashboard</Link>
                            </li>
                            <li>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    <a href="https://github.com/lucasns06/churninsight-frontend" class="text-body hover:text-heading ms-5">
