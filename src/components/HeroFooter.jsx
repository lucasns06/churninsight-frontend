    ...
    return (
        <footer class="bg-[#020617]">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 ">
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="https://github.com/lucasns06/churninsight-frontend" class="hover:underline" target="_blank" rel="noopener noreferrer">Front end</a>
                            </li>
                            <li class="mb-4">
                                <a href="https://github.com/renancvitor/churninsight-backend-h12-25b" class="hover:underline" target="_blank" rel="noopener noreferrer">Back end</a>
                            </li>
                             <li>
                                <a href="https://github.com/LeticiaPaesano/Churn_Hackathon" class="hover:underline" target="_blank" rel="noopener noreferrer">Data science</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <Link to="/previsao" class="hover:underline">Previsão</Link>
                            </li>
                            <li class="mb-4">
                                <Link to="/dashboard" class="hover:underline">Dashboard</Link>
                            </li>
                            <li>
                                <Link to="/membros" class="hover:underline">Membros</Link>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-body sm:text-center">HACKATON - NO COUNTRY - Oracle Next One - ALURA
                </span>
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    <a href="https://github.com/lucasns06/churninsight-frontend" class="text-body hover:text-heading ms-5" target="_blank" rel="noopener noreferrer">
