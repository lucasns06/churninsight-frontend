...
const Previsao = () => {
    ...
    return (
        <div className="min-h-[calc(100dvh-64px)]  flex flex-col justify-center items-center px-2 py-8 sm:py-4">
            <div className="md:absolute md:top-22 md:left-6/12 md:-translate-x-6/12 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/30 text-primary-foreground mb-6 border border-blue-500/40">
                        ...
                        <div className='w-full'>
                            <div className="h-22 relative">
                                ...
                                <input
                                    ...
                                    {...register("CreditScore", { required: "Campo Obrigatório", min: { value: 350, message: "O valor mínimo é 350!" }, max: { value: 850, message: "O valor máximo é 850" }, valueAsNumber: true })}
