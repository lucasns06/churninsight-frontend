                ...
                {cardsBack.map((cards) => (
                    <div key={cards.id} className="bg-white relative bg-neutral-primary-soft max-w-2xs w-full p-6 rounded-2xl shadow-md border border-white hover:-translate-y-2 hover:border-blue-500/50 hover:shadow-xl transition-all">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex flex-col items-center mt-4 md:mt-6 gap-4">
                                <a href={cards.linkedin} target="_blank" rel="noopener noreferrer">
                                    <button
                                        type="button"
                                        data-twe-ripple-init
                                        data-twe-ripple-color="light"
                                        className="inline-block hover:cursor-pointer rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                                ...
                                <a href={cards.github} target="_blank" rel="noopener noreferrer">
                                    <button type="button" className="hover:cursor-pointer rounded text-white bg-[#0f1419] hover:bg-[#0f1419]/90 focus:ring-[#0f1419]/50 box-border border border-transparent font-medium leading-5 rounded-base text-sm px-4 py-2.5 text-center inline-flex items-center dark:hover:bg-[#24292F] dark:focus:ring-[#24292F]/55 shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
