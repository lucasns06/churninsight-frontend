...
const Membros = () => {
    return (
        <div className="min-h-[calc(100dvh-64px)]  sm:h-auto  pb-4 py-2">
            ...
            <h1 className="text-4xl text-center font-bold my-4">Nossa <span className='text-blue-500'>Equipe</span></h1>
            <div className="flex flex-wrap justify-center gap-4">
                {cardsBack.map((membro) => (
                    <div key={membro.id} className="bg-white group relative bg-neutral-primary-soft max-w-2xs w-full p-6 rounded-2xl shadow-md border-2 border-white hover:-translate-y-2 hover:border-blue-600/80 hover:shadow-xl transition-all">
                        <div className="flex flex-col items-center">
                            <img className="w-24 h-24 mb-6 rounded-full border-2 shadow-md border-white group-hover:border-blue-600/80" src={membro.fotoUrl} alt="person" />
                            <h5 className="mb-0.5 text-xl font-bold tracking-tight text-heading">{membro.nome}</h5>
                            <span className="text-md text-blue-500">{membro.cargo}</span>
                            <div className="flex items-center mt-4 md:mt-6 gap-4">
                                <a href={membro.linkedin} target="_blank" rel="noopener noreferrer">
                                    <button
                                        ...
                                        className="inline-block hover:cursor-pointer rounded-xl px-2 py-1 text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                                ...
                                <a href={membro.github} target="_blank" rel="noopener noreferrer">
                                    <button type="button" className="flex items-center hover:cursor-pointer rounded-xl px-2 py-1 text-base font-medium leading-normal bg-black text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
            ...
            <div className="w-full flex justify-center items-center gap-2 my-4">
                ...
                <div className="w-32 h-1 bg-blue-300 rounded-4xl"></div>
                <div className="w-2 h-2 bg-blue-300 rounded-full"></div>
            </div>
            <div className="flex flex-wrap justify-center gap-4">
                {cardsData.map((membro) => (
                    <div key={membro.id} className="bg-white group relative bg-neutral-primary-soft max-w-2xs w-full p-6 rounded-2xl shadow-md border-2 border-white hover:-translate-y-2 hover:border-blue-600/80 hover:shadow-xl transition-all">
                        <div className="flex flex-col items-center">
                            <img className="w-24 h-24 mb-6 rounded-full border-2 shadow-md border-white group-hover:border-blue-600/80" src={membro.fotoUrl} alt="person" />
                            <h5 className="mb-0.5 text-xl font-bold tracking-tight text-heading">{membro.nome}</h5>
