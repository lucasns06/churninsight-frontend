        ...
        <div className="tela sm:h-auto  pb-4 py-2">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                {cardsBack.map((membro) => (
                    <div key={membro.id} className="bg-white group relative bg-neutral-primary-soft max-w-2xs w-full p-6 rounded-2xl shadow-md border border-white hover:-translate-y-2 hover:border-blue-600/80 hover:shadow-xl transition-all naosei">
                        <div className="flex flex-col items-center">
                            <img className="w-24 h-24 mb-6 rounded-full border border-white group-hover:border-blue-600/80" src={membro.fotoUrl} alt="person" />
                            <h5 className="mb-0.5 text-xl font-semibold tracking-tight text-heading">{membro.nome}</h5>
                            <span className="text-md">{membro.cargo}</span>
            ...
            <div className="flex flex-wrap justify-center gap-4">
                {cardsData.map((membro) => (
                    <div key={membro.id} className="bg-white group relative bg-neutral-primary-soft max-w-2xs w-full p-6 rounded-2xl shadow-md border border-white hover:-translate-y-2 hover:border-blue-600/80 hover:shadow-xl transition-all">
                        <div className="flex flex-col items-center">
                            <img className="w-24 h-24 mb-6 rounded-full border border-white group-hover:border-blue-600/80" src={membro.fotoUrl} alt="person" />
                            <h5 className="mb-0.5 text-xl font-semibold tracking-tight text-heading">{membro.nome}</h5>
                            <span className="text-md">{membro.cargo}</span>
